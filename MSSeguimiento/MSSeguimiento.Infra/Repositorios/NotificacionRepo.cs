...
namespace MSSeguimiento.Infra.Repositorios
{
    public class NotificacionRepo : INotificacionRepo
    {
        ...
        public async Task<string> EnviarOficioNotificacion(EnviarOficioNotifcacionRequest request)
        {
            ...
            {
                notificacionEntidadPlantilla.EdadNNA = DateTime.Today.Year - notificacionEntidadPlantilla.FechaNacimientoNNA.Year - 
                    (DateTime.Today.DayOfYear < notificacionEntidadPlantilla.FechaNacimientoNNA.DayOfYear ? 1 : 0);
